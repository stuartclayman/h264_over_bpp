...
public class BPPForward {
    ...
    public static void main(String[] args) {
        ...
        if (Verbose.level >= 2) {
            ...
            System.err.println("Forward to host: " + host);
    ...
    static void usage() {
        System.err.println("BPPListen [-b bandwidth] [-p list_port] [-h forward_host] [-P forward_port] [-c cols]");
        System.exit(1);
    }
    ...
    protected static void processTraffic() throws IOException {
        ...
        // Setup UDP Sender
        sender = new UDPSender(host, forwardPort);
        sender.start();
    ...
    protected static void datagramProcess(DatagramPacket packet) throws UnknownHostException {
